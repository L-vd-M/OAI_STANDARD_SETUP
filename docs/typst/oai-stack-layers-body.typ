...
#v(0.3em)#line(length: 100%, stroke: 0.5pt + rgb("#cccccc"))#v(0.3em)
...
#figure(image("mermaid-assets-stack-layers/01-ran-layer-stack.png", width: 100%, height: 19cm, fit: "contain"))
...
#figure(image("mermaid-assets-stack-layers/02-itti-routing.png", width: 100%, height: 19cm, fit: "contain"))
...
#table(
  ...
  fill: (col, row) => if row == 0 { rgb("#003366") } else if calc.odd(row) { rgb("#f5f8fc") } else { white },
  [#text(fill: white, weight: "bold")[Message]], [#text(fill: white, weight: "bold")[Direction]], [#text(fill: white, weight: "bold")[Function]], [#text(fill: white, weight: "bold")[File:line]],
  [F1 Setup Request], [DU→CU], [#text(fill: rgb("#a03050"))[DU\_​send\_​F1\_​SETUP\_​REQUEST(​.​.​.​)​]], [#text(fill: rgb("#a03050"))[f1ap\_​du\_​interface\_​management.​c:​142]],
  [F1 Setup Response], [CU→DU], [#text(fill: rgb("#a03050"))[CU\_​send\_​F1\_​SETUP\_​RESPONSE(​.​.​.​)​]], [#text(fill: rgb("#a03050"))[f1ap\_​cu\_​interface\_​management.​c:​117]],
  [DL RRC Message Transfer], [CU→DU], [#text(fill: rgb("#a03050"))[CU\_​send\_​DL\_​RRC\_​MESSAGE\_​TRANSFER(​.​.​.​)​]], [#text(fill: rgb("#a03050"))[f1ap\_​cu\_​rrc\_​message\_​transfer.​c:​69]],
  [DL RRC Message Transfer (recv)], [at DU], [#text(fill: rgb("#a03050"))[DU\_​handle\_​DL\_​RRC\_​MESSAGE\_​TRANSFER(​.​.​.​)​]], [#text(fill: rgb("#a03050"))[f1ap\_​du\_​rrc\_​message\_​transfer.​c:​58]],
  [UL RRC Message Transfer (recv)], [at CU], [#text(fill: rgb("#a03050"))[CU\_​handle\_​UL\_​RRC\_​MESSAGE\_​TRANSFER(​.​.​.​)​]], [#text(fill: rgb("#a03050"))[f1ap\_​cu\_​rrc\_​message\_​transfer.​c:​97]],
  [Initial UL RRC Message Transfer (recv)], [at CU], [#text(fill: rgb("#a03050"))[CU\_​handle\_​INITIAL\_​UL\_​RRC\_​MESSAGE\_​TRANSFER(​.​.​.​)​]], [#text(fill: rgb("#a03050"))[f1ap\_​cu\_​rrc\_​message\_​transfer.​c:​48]],
  [Initial UL RRC Message Transfer], [DU→CU], [#text(fill: rgb("#a03050"))[DU\_​send\_​INITIAL\_​UL\_​RRC\_​MESSAGE\_​TRANSFER(​.​.​.​)​]], [#text(fill: rgb("#a03050"))[f1ap\_​du\_​rrc\_​message\_​transfer.​c:​74]],
)
]


#figure(image("mermaid-assets-stack-layers/03-f1ap-seq.png", width: 100%, height: 19cm, fit: "contain"))
...
#figure(image("mermaid-assets-stack-layers/04-e1ap-seq.png", width: 100%, height: 19cm, fit: "contain"))
...
#figure(image("mermaid-assets-stack-layers/05-ngap-seq.png", width: 100%, height: 19cm, fit: "contain"))
...
#figure(image("mermaid-assets-stack-layers/06-5gc-topology.png", width: 100%, height: 19cm, fit: "contain"))
...
#figure(image("mermaid-assets-stack-layers/07-userplane-packet.png", width: 100%, height: 19cm, fit: "contain"))
...
#table(
  ...
  stroke: 0.5pt + rgb("#cccccc"),
  fill: (col, row) => if row == 0 { rgb("#003366") } else if calc.odd(row) { rgb("#f5f8fc") } else { white },
  [#text(fill: white, weight: "bold")[Layer/Interface]], [#text(fill: white, weight: "bold")[Repo location]], [#text(fill: white, weight: "bold")[Spec (background)]], [#text(fill: white, weight: "bold")[Crosses to neighbor via]],
  [PHY], [#text(fill: rgb("#a03050"))[openair1/​SCHED\_​NR\*], #text(fill: rgb("#a03050"))[openair1/​PHY]], [TS 38.201/38.211-214], [nFAPI structs (#text(fill: rgb("#a03050"))[NR\_​Sched\_​Rsp\_​t], #text(fill: rgb("#a03050"))[NR\_​UL\_​IND\_​t])],
  [MAC], [#text(fill: rgb("#a03050"))[openair2/​LAYER2/​NR\_​MAC\_​gNB], #text(fill: rgb("#a03050"))[NR\_​MAC\_​UE]], [TS 38.321], [#text(fill: rgb("#a03050"))[nr\_​mac\_​rlc\_​data\_​req/​ind(​)​]],
  [RLC], [#text(fill: rgb("#a03050"))[openair2/​LAYER2/​nr\_​rlc]], [TS 38.322], [#text(fill: rgb("#a03050"))[nr\_​rlc\_​data\_​req(​)​] / #text(fill: rgb("#a03050"))[deliver\_​sdu(​)​] → #text(fill: rgb("#a03050"))[nr\_​pdcp\_​data\_​ind(​)​]],
  [PDCP], [#text(fill: rgb("#a03050"))[openair2/​LAYER2/​nr\_​pdcp]], [TS 38.323], [#text(fill: rgb("#a03050"))[nr\_​pdcp\_​data\_​req\_​srb/​drb(​)​] / #text(fill: rgb("#a03050"))[nr\_​pdcp\_​data\_​ind(​)​]],
  [SDAP], [#text(fill: rgb("#a03050"))[openair2/​SDAP/​nr\_​sdap]], [TS 37.324], [#text(fill: rgb("#a03050"))[sdap\_​data\_​req(​)​] / #text(fill: rgb("#a03050"))[sdap\_​data\_​ind(​)​]],
  [RRC], [#text(fill: rgb("#a03050"))[openair2/​RRC/​NR], #text(fill: rgb("#a03050"))[NR\_​UE]], [TS 38.331], [ITTI (#text(fill: rgb("#a03050"))[TASK\_​RRC\_​GNB]/#text(fill: rgb("#a03050"))[TASK\_​RRC\_​NRUE])],
  [F1AP], [#text(fill: rgb("#a03050"))[openair2/​F1AP]], [TS 38.470/38.473], [ITTI (#text(fill: rgb("#a03050"))[TASK\_​CU\_​F1]/#text(fill: rgb("#a03050"))[TASK\_​DU\_​F1]) + SCTP between CU/DU],
  [E1AP], [#text(fill: rgb("#a03050"))[openair2/​E1AP]], [TS 37.483], [ITTI (#text(fill: rgb("#a03050"))[TASK\_​CUCP\_​E1]/#text(fill: rgb("#a03050"))[TASK\_​CUUP\_​E1]) + SCTP between CU-CP/CU-UP],
  [NGAP (RAN side)], [#text(fill: rgb("#a03050"))[openair3/​NGAP]], [TS 38.410/38.413], [ITTI (#text(fill: rgb("#a03050"))[TASK\_​NGAP]) + SCTP to AMF],
  [ITTI (RAN)], [#text(fill: rgb("#a03050"))[common/​utils/​ocp\_​itti]], [— (OAI-internal)], [#text(fill: rgb("#a03050"))[itti\_​send\_​msg\_​to\_​task(​)​]],
  [NGAP (AMF side)], [#text(fill: rgb("#a03050"))[oai-cn5g-amf/​src/​ngap] (+ codec in #text(fill: rgb("#a03050"))[oai-cn5g-common-src/​ngap])], [TS 38.413], [AMF's own ITTI (#text(fill: rgb("#a03050"))[TASK\_​AMF\_​N2])],
  [NAS (AMF side)], [#text(fill: rgb("#a03050"))[oai-cn5g-amf/​src/​nas] (+ codec in #text(fill: rgb("#a03050"))[oai-cn5g-common-src/​nas])], [TS 24.501], [AMF's own ITTI (#text(fill: rgb("#a03050"))[TASK\_​AMF\_​N1])],
  [SBI (AMF↔SMF/AUSF/UDM)], [#text(fill: rgb("#a03050"))[oai-cn5g-\*\/​src/​sbi]], [TS 29.500 + per-NF specs], [HTTP/2 + JSON],
  [PFCP (SMF↔UPF)], [#text(fill: rgb("#a03050"))[oai-cn5g-smf/​src/​pfcp], #text(fill: rgb("#a03050"))[oai-cn5g-upf/​src/​pfcp]], [TS 29.244], [UDP],
  [GTP-U (UPF↔RAN/UE data)], [#text(fill: rgb("#a03050"))[oai-cn5g-upf/​src/​gtpv1u] (CN side); RAN's #text(fill: rgb("#a03050"))[TASK\_​GTPV1\_​U] (RAN side)], [TS 29.281], [UDP tunnel],
)
]
...
- #link("https://www.etsi.org/deliver/etsi_ts/138300_138399/138300/18.06.00_60/ts_138300v180600p.pdf")[ETSI TS 138 300 — 5G NR and NG-RAN Overall description] — layer/interface overview (background)
- #link("https://www.etsi.org/deliver/etsi_ts/138400_138499/138401/18.07.00_60/ts_138401v180700p.pdf")[ETSI TS 138 401 — NG-RAN Architecture description] — CU/DU, CU-CP/CU-UP split rationale
- #link("https://www.etsi.org/deliver/etsi_ts/138300_138399/138321/18.05.00_60/ts_138321v180500p.pdf")[ETSI TS 138 321 — NR MAC protocol]
- #link("https://www.etsi.org/deliver/etsi_ts/138300_138399/138322/18.01.00_60/ts_138322v180100p.pdf")[ETSI TS 138 322 — NR RLC protocol]
- #link("https://www.etsi.org/deliver/etsi_ts/138300_138399/138323/17.05.00_60/ts_138323v170500p.pdf")[ETSI TS 138 323 — NR PDCP protocol]
- #link("https://www.etsi.org/deliver/etsi_ts/138300_138399/138331/18.05.01_60/ts_138331v180501p.pdf")[ETSI TS 138 331 — NR RRC protocol]
- #link("https://www.etsi.org/deliver/etsi_ts/138400_138499/138413/18.05.00_60/ts_138413v180500p.pdf")[ETSI TS 138 413 — NGAP (NG Application Protocol)]
- #link("https://www.etsi.org/deliver/etsi_ts/138400_138499/138473/18.01.00_60/ts_138473v180100p.pdf")[ETSI TS 138 473 — F1AP (F1 Application Protocol)]
- #link("https://www.etsi.org/deliver/etsi_ts/137400_137499/137483/18.01.00_60/ts_137483v180100p.pdf")[ETSI TS 137 483 — E1AP (E1 Application Protocol)]
- #link("https://www.etsi.org/deliver/etsi_ts/129200_129299/129244/18.06.00_60/ts_129244v180600p.pdf")[ETSI TS 129 244 — PFCP (Packet Forwarding Control Protocol)]
- #link("https://www.etsi.org/deliver/etsi_ts/129500_129599/129500/17.12.00_60/ts_129500v171200p.pdf")[ETSI TS 129 500 — 5G System Service Based Architecture, technical realization]
